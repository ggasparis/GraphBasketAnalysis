#Load packages and createa  percent formatter function
...
p <- plot_court(court_themes$light) +
  ...
  guides(fill=guide_legend(
    ...
    label.vjust = 3,
    nrow = 1))  +
  theme(text=element_text(size=14,  family="Meslo LG S Regular for Powerline"), 
